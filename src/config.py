...
CLASSICAL_MODELS_DIR: Path = MODELS_DIR / "classical"
NOTEBOOKS_DIR: Path = PROJECT_ROOT / "notebooks"
OUTPUTS_DIR: Path = PROJECT_ROOT / "outputs"
GEOGRAPHIC_OUTPUTS_DIR: Path = OUTPUTS_DIR / "geographic"
CLASSICAL_OUTPUTS_DIR: Path = OUTPUTS_DIR / "classical"
...
def get_project_paths() -> Dict[str, Path]:
    ...
    return {
        ...
        "CLASSICAL_MODELS_DIR": CLASSICAL_MODELS_DIR,
        "NOTEBOOKS_DIR": NOTEBOOKS_DIR,
        "OUTPUTS_DIR": OUTPUTS_DIR,
        "GEOGRAPHIC_OUTPUTS_DIR": GEOGRAPHIC_OUTPUTS_DIR,
        "CLASSICAL_OUTPUTS_DIR": CLASSICAL_OUTPUTS_DIR,
